...
class BootStrap {
    ...
    private createSampleData() {
        ...
        Post[] postsAsList = phil.posts as List
        postsAsList[0].addToTags(user: phil, name: "groovy")
        postsAsList[0].addToTags(user: phil, name: "grails")
        postsAsList[0].dateCreated = now.copyWith(year: 2006, month: Calendar.MARCH, date: 13)
        ...
        postsAsList[1].dateCreated = now.copyWith(year: 2007, month: Calendar.FEBRUARY, date: 13)

        postsAsList[2].addToTags(user: phil, name: "groovy")
        postsAsList[2].addToTags(user: phil, name: "bbq")
        postsAsList[2].dateCreated = now.copyWith(year: 2009, month: Calendar.OCTOBER)

        postsAsList[3].addToTags(user: phil, name: "groovy")
        postsAsList[3].dateCreated = now.copyWith(year: 2011, month: Calendar.MAY, date: 1)

        postsAsList[4].dateCreated = now.copyWith(year: 2011, month: Calendar.DECEMBER, date: 4)
        postsAsList[5].dateCreated = now.copyWith(year: 2012, date: 10)
        phil.save(failOnError: true)

        postsAsList = sara.posts as List
        postsAsList[0].dateCreated = now.copyWith(year: 2007, month: Calendar.MAY)
        postsAsList[1].dateCreated = now.copyWith(year: 2008, month: Calendar.APRIL, date: 13)
        postsAsList[2].dateCreated = now.copyWith(year: 2008, month: Calendar.APRIL, date: 24)
        postsAsList[3].dateCreated = now.copyWith(year: 2011, month: Calendar.NOVEMBER, date: 8)
        postsAsList[4].dateCreated = now.copyWith(year: 2011, month: Calendar.DECEMBER, date: 4)
        postsAsList[5].dateCreated = now.copyWith(year: 2012, month: Calendar.AUGUST, date: 1)
